...
dog_cat_Icons <- icons(
  iconUrl = ifelse(df_map$`Are you a dog or cat person?` == "Dog",
    "https://commons.wikimedia.org/wiki/File:201412_dog.png", "https://purepng.com/public/uploads/large/purepng.com-catcatcatsanimalspetscute-cat-251520163946lt4hc.png"),
  iconWidth = 17, iconHeight = 30,
  iconAnchorX = 17, iconAnchorY = 30)
