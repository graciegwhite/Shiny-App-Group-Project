...
#adding layer of points for home state. Proof of concept that it works with the voles layer from lab.  

#How do we develop a map layer that shows a randomly generated point within each state, or centrally located within each state? To show the distribution of certain personality traits. This page has coordinates for the geographic center in each state. Do you think it would be possible to make this into a csv and reference that as a layer?: https://en.wikipedia.org/wiki/List_of_geographic_centers_of_the_United_States.
