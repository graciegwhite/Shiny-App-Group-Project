...
#This works! But it is missing some aspects before it can be utilized in the shiny app.
...
#Trying some other leaflet things. This is working and tied to the functional hogIcons object:
